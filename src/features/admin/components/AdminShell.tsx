      ...
      <div className="flex items-center justify-between px-2 mb-8">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-md bg-primary flex items-center justify-center shrink-0">
            <span className="text-primary-fg text-xs font-black">{estabelecimentoNome.charAt(0).toUpperCase()}</span>
          </div>
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="p-1 rounded-md text-muted hover:text-foreground hover:bg-background-secondary transition-colors lg:hidden"
      ...
      <div className="relative pt-4 border-t border-border">
        {menuUserAberto && (
          <div className="absolute bottom-full left-0 right-0 mb-2 bg-card border border-border rounded-xl shadow-lg overflow-hidden z-50">
            <div className="p-3 border-b border-border bg-background-secondary/60">
            ...
            <div className="p-1 space-y-0.5">
              <Link
                ...
                target="_blank"
                prefetch={false}
                className="flex items-center gap-2.5 px-3 py-2 text-xs font-medium text-foreground rounded-lg hover:bg-background-secondary transition-colors"
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium text-error-fg rounded-lg hover:bg-error-bg transition-colors text-left cursor-pointer"
              >
                <LogOut size={14} className="text-error-fg" />
                Sair da Conta
              </button>
            </div>
          </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-between p-2 rounded-lg hover:bg-background-secondary transition-colors cursor-pointer text-left group"
        >
          ...
          <MoreVertical size={16} className="text-muted group-hover:text-foreground shrink-0 ml-1" />
        </button>
      </div>
    </aside>
  );
  ...
  return (
    <header className="h-16 flex items-center justify-between px-4 sm:px-8 border-b border-border bg-card/80 backdrop-blur-md sticky top-0 z-20 shrink-0">
      <div className="flex items-center gap-4">
        <button
          onClick={onMenuClick}
          className="p-2 rounded-lg text-muted hover:text-foreground hover:bg-background-secondary transition-colors lg:hidden"
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Notificações */}
        <button
          className="relative p-2 rounded-xl text-muted hover:text-foreground hover:bg-background-secondary transition-colors border border-border/40"
