            ...
            <div className="max-w-md w-full bg-card rounded-2xl shadow-xl p-8 space-y-6 border border-border">
                ...
                <div className="text-center">
                    ...
                    <p className="text-sm text-muted mt-2">
                        Cadastre-se para garantir sua vaga nos eventos
                    </p>
                </div>
...
function SuccessState({ email }: { email: string }) {
    return (
        <div className="bg-success-bg text-success-fg p-6 rounded-xl text-center space-y-4">
            <svg className="w-12 h-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
            ...
            <Link
                href="/auth/login"
                className="block w-full bg-success-action hover:bg-success-action-hover text-white font-medium py-2.5 rounded-lg transition-colors"
            >
                Ir para o Login
            </Link>
        </div>
